  ...
  return (
    <>
      ...
      <TableRow onClick={() =>
        ...
        <TableCell  align="right" >{address} {City.city}</TableCell>
...
>
<ModeEditIcon onClick={(e) =>{ e.stopPropagation();navigate( `/initiators/${initiatorId}/update-project/${idProject}`)
}}></ModeEditIcon>
   <EditIcon />
 </Fab> */}
            <ModeEditIcon onClick={(e) => {
              e.stopPropagation(); navigate(`/initiators/${initiatorId}/update-project/${idProject}`)
            }}></ModeEditIcon>
          </>
